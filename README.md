...
- Deleting takes two clicks: the ✕ turns into **Sure?**, and clicking anywhere else cancels. A single
  misclick cannot destroy a record, and no modal dialog is involved.
